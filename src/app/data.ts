import { PreferenceOwner, Preference, PreferenceDefinition, OwnerType, Category } from "./api/models";
...
export class Config {
    ...
    defMap: Map<string, PreferenceDefinition>;
}
